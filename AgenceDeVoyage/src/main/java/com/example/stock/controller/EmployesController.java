...
@Component
@FxmlView("Employe.fxml")
public class EmployesController {
	private final FxWeaver fxWeaver;

	@FXML
	private AnchorPane employesPage;
	@FXML
	...
	public EmployesController(FxWeaver fxWeaver,
	...
	public void initialize() {
		ajouterEtModifier.setOnAction(event ->{
			...
			boder.setCenter(Tools.loadPage(fxWeaver, registerLoginController.class, AnchorPane.class));			
			});	
		listes.setOnAction(event ->{
			...
			boder.setCenter(Tools.loadPage(fxWeaver, ListeDesEmployesController.class, AnchorPane.class));				
		});	
	}
