...
public class VolsController {
	...
	public VolsController(FxWeaver fxWeaver,
	...
	public void initialize() {
		ajouterEtModifier.setOnAction(event ->{
			...
			boder.setCenter(Tools.loadPage(fxWeaver, ajouterUnVolController.class, AnchorPane.class));			
			});	
		listes.setOnAction(event ->{
			...
			boder.setCenter(Tools.loadPage(fxWeaver, ListesDesVolsController.class, AnchorPane.class));				
		});	
	}
