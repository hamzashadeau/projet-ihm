...
@Component
@FxmlView("Voyages.fxml")
public class VoyagesController {
	private final FxWeaver fxWeaver;

	@FXML
	private AnchorPane voyagesPage;
	@FXML
	...
	public VoyagesController(FxWeaver fxWeaver,
	...
	public void initialize() {
		ajouterEtModifier.setOnAction(event ->{
			...
			boder.setCenter(Tools.loadPage(fxWeaver, ajouterUnVoyageController.class, AnchorPane.class));			
			});	
		listes.setOnAction(event ->{
			...
			boder.setCenter(Tools.loadPage(fxWeaver, ListesDesVoyagesController.class, AnchorPane.class));				
		});	
	}
